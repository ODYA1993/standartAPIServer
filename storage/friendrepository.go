...
func (fr *FriendRepository) CreateFriends(friend *models.Friends) (*models.Friends, error) {
	...
	if err := fr.storage.db.QueryRow(
		...
		friend.UserID,
		friend.FriendID,
	).Scan(&friend.ID); err != nil {
		return nil, err
	}
	return friend, nil
}

func (fr *FriendRepository) GetFriends(id int) ([]*models.User, error) {
